...
wget https://distfiles.macports.org/szip/szip-2.1.1.tar.gz -O /root/szip-2.1.1.tar.gz --no-ch

cp /root/szip-2.1.1.tar.gz .
#I have prepared zip-2.1.1.tar.gz in the root directory,Otherwise, you need to execute the following command to download zip-2.1.1.tar.gz
#wget https://distfiles.macports.org/szip/szip-2.1.1.tar.gz -O /root/szip-2.1.1.tar.gz --no-ch
...
wget https://support.hdfgroup.org/ftp/HDF5/releases/hdf5-1.8/hdf5-1.8.12/src/hdf5-1.8.12.tar.gz -O /root/hdf5-1.8.12.tar.gz --no-ch

cp /root/hdf5-1.8.12.tar.gz .
#I have prepared hdf5-1.8.12.tar.gz in the root directory,Otherwise, you need to execute the following command to download hdf5-1.8.12.tar.gz
#wget https://support.hdfgroup.org/ftp/HDF5/releases/hdf5-1.8/hdf5-1.8.12/src/hdf5-1.8.12.tar.gz -O /root/hdf5-1.8.12.tar.gz --no-ch
